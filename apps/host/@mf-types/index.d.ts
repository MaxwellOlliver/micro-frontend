import type { PackageType as PackageType_0,RemoteKeys as RemoteKeys_0 } from './dashboard/apis.d.ts';
import type { PackageType as PackageType_1,RemoteKeys as RemoteKeys_1 } from './users/apis.d.ts';
